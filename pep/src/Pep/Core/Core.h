...
#define PEP_PLATFORM_IOS
#error "IOS is not supported!"
#elif TARGET_OS_MAC == 1
#define PEP_PLATFORM_MACOS
...
#define PEP_PLATFORM_ANDROID
#error "Android is not supported!"
#elif defined(__linux__)
#define PEP_PLATFORM_LINUX
